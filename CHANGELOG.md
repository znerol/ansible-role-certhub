...
- feat(role): Update to certhub v1.4.0 (#38)

### Changed

- fix(ci): Fix integration tests (#39)
- fix(role): Lookup facts in ansible_facts (#40)
...
[Unreleased]: https://github.com/znerol/ansible-role-certhub/compare/v1.5.0...HEAD
[1.5.0]: https://github.com/znerol/ansible-role-certhub/compare/v1.4.0...v1.5.0
